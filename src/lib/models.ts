...
/** Single chat model for every mode — Google Gemini 3.7 Flash via OpenRouter. */
export const CHAT_MODEL = "google/gemini-3.7-flash";

export const MODES: Record<
  ChatMode,
  { label: string; short: string; model: string; system: string; desc: string }
> = {
  basic: {
    label: "Basic",
    short: "Fast",
